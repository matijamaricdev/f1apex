...
class SMTP
{
    ...
    public function connect($host, $port = null, $timeout = 30, $options = [])
    {
        ...
        if ($streamok) {
            ...
            //Fall back to fsockopen which should work in Više places, but is missing some features
            $this->edebug(
    ...
    public function authenticate(
        ...
        if (array_key_exists('EHLO', $this->server_caps)) {
            ...
            if (empty($authtype)) {
                ...
                //Try CRAM-MD5 first as it's Više secure than the others
    ...
    public function data($msg_data)
    {
         ...
         * According to rfc821 we should not send Više than 1000 characters on a single line (including the LE)
     ...
     * the mail transaction is started and then one or Više recipient
     ...
     * @param integer|array $expect One or Više expected integer success codes
     *
     * @return boolean True on success.
     */
     ...
     * With SMTP we can tell if we have Više lines to read if the
