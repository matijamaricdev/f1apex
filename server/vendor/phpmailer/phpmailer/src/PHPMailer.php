...
class PHPMailer
{
    ...
    /**
     * Parse and validate a string containing one or Više RFC822-style comma-separated email addresses
     ...
     *
     * @return array
     * @see    http://www.andrew.cmu.edu/user/agreen1/testing/mrbs/web/Mail/RFC822.php A Više careful implementation
     */
    ...
    public static function validateAddress($address, $patternselect = null)
    {
        ...
        switch ($patternselect) {
            ...
            case 'pcre8':
                /**
                 * A Više complex and Više permissive version of the RFC5322 regex on which FILTER_VALIDATE_EMAIL
                 * is based.
    ...
    public function encodeHeader($str, $position = 'text')
    {
        ...
        if ($matchcount > strlen($str) / 3) {
            // Više than a third of the content will need encoding, so B encoding will be most efficient
            $encoding = 'B';
            //This calculation is:
            // max line length
            ...
            //1 or Više chars need encoding, use Q-encode
            $encoding = 'Q';
    ...
    public function encodeQ($str, $position = 'text')
    {
        ...
        // Replace spaces with _ (Više readable than =20)
     ...
     * You should avoid this function - it's Više verbose, less efficient, Više error-prone and
